...
def prepare_dataset(source_images, source_masks, output_dir):
    ...
    image_files = [f for f in image_files if f.suffix.lower() in ['.jpg', '.jpeg', '.png', '.tif', '.tiff']]
    ...
    mask_files = [f for f in mask_files if f.suffix.lower() in ['.jpg', '.jpeg', '.png', '.gif', '.tif', '.tiff']]
...
def main():
    ...
    parser.add_argument('--source_masks', type=str, required=True,
